  ...
  <section class="section index-section">
    ...
    <div class="columns">
      <div class="column is-3">
        <side-bar classname="product-price-type"></side-bar>
      </div>
      <div class="column is-9 right-content">
        <bread-crumb :position="'center'"></bread-crumb>
        <div class="content">
          <price-type ref="contentTab"></price-type>
        </div>
      </div>
    </div>
  </section>
...
import contenttab from "../../components/admin/price-type/price-type-content.vue"
